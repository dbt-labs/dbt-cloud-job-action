...
- `failure_on_error` - Boolean to make the action report a failure when the dbt Cloud job does not succeed (status is not Success). This includes Error and Cancelled states.
